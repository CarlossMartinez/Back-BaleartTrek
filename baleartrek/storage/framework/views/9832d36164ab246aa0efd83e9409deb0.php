                        ...
                        <div class="mb-3">
                            ...
                            <select name="municipality_id" class="mt-1 block w-full">   
                                <?php $__currentLoopData = $municipalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($municipality->id); ?>" <?php if(old('municipality_id') == $municipality->id): echo 'selected'; endif; ?>>
...
<?php endif; ?><?php /**PATH C:\Users\carke\Clases-FP\BalearTrek\baleartrek\resources\views/trekCRUD/edit.blade.php ENDPATH**/ ?>