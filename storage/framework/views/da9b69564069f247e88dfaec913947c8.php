        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="<?php echo e(route('userCRUD.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php endif; ?><?php /**PATH C:\Users\carke\Clases-FP\BalearTrek\baleartrek\resources\views/userCRUD/create.blade.php ENDPATH**/ ?>