        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="<?php echo e(route('trekCRUD.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" name="regNumber" value="<?php echo e(old('regNumber')); ?>" />
...
<?php endif; ?><?php /**PATH C:\Users\carke\Clases-FP\BalearTrek\baleartrek\resources\views/trekCRUD/create.blade.php ENDPATH**/ ?>