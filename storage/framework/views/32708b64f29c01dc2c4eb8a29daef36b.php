...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Editar Municipality:')); ?> <?php echo e($municipality->name); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="<?php echo e(route('municipalityCRUD.update', $municipality->id)); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name', $municipality->name)); ?>" />
...
unset($__errorArgs, $__bag); ?>" name="island_id">
                                ...
                                <?php $__currentLoopData = $islands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $island): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($island->id); ?>" <?php if(old('island_id', $municipality->island_id) == $island->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>" name="zone_id">
                                ...
                                <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($zone->id); ?>" <?php if(old('zone_id', $municipality->zone_id) == $zone->id): echo 'selected'; endif; ?>>
...
<?php endif; ?><?php /**PATH C:\Users\carke\Clases-FP\BalearTrek\baleartrek\resources\views/municipalityCRUD/edit.blade.php ENDPATH**/ ?>